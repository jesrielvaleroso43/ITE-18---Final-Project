...
import { submitRun as submitRunToAPI } from "../api";
import { ref } from "vue";
...
const emit = defineEmits(["switch", "start", "reset", "toggleFullscreen", "updateSettings", "pause", "toggleCursor"]);
